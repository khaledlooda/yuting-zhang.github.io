...
**Solution:**
We want to generate all the possible humble numbers in range one by one, 
from the least to the greatest. To do this without generating duplicates,
we can keep track of four pointers.
...
[Humble Numbers]:https://uva.onlinejudge.org/index.php?option=com_onlinejudge&Itemid=8&category=24&page=show_problem&problem=384
